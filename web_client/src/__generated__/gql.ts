...
const documents: Documents = {
    ...
    "\n  fragment ImageDetailFields on Image {\n    id\n    url\n    name\n    identifier\n    nominalWidth\n    nominalHeight\n    MIMEType\n    createdAt\n    changes\n    createdBy {\n      id\n    }\n    lineage {\n      id\n      url\n      name\n      changes\n      createdAt\n    }\n  }\n": types.ImageDetailFieldsFragmentDoc,
    "\n  query ImageDetail($id: ID!) {\n    viewer {\n      id\n      organizationUser {\n        id\n      }\n      image(id: $id) {\n        ...ImageDetailFields\n      }\n    }\n  }\n": types.ImageDetailDocument,
    "\n  query PublicImageDetail($id: ID!) {\n    viewer {\n      id\n      organizationUser {\n        id\n      }\n    }\n    publicImage(id: $id) {\n      ...ImageDetailFields\n    }\n  }\n": types.PublicImageDetailDocument,
